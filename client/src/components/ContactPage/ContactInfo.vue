        ...
        <div class="col-lg-4 responsive-column">
          <div class="info-box info--box">
            ...
            <div class="info-content">
              ...
              <p class="info__desc">
                <a href="tel:+1811864592" class="btn-text">+1 (811) 86 45 92</a>
              </p>
            </div>
            <!-- end info-content -->
          </div>
        ...
        <div class="col-lg-4 responsive-column">
          <div class="info-box info--box">
            ...
            <div class="info-content">
              ...
              <p class="info__desc">
                <a href="mailto:dirto@gamil.com" class="btn-text"
                  >listhub@gmail.com</a
                >
              </p>
            </div>
              ...
              <form method="post" class="form-box row">
                ...
                <div class="col-lg-12">
                  <div class="btn-box">
                    <button
                      type="submit"
                      class="theme-btn gradient-btn border-0"
                    >
            ...
            <div class="block-card-body">
              ...
              <ul class="list-items list--items list-items-style-2 py-4">
                <li>
                  <span class="text-color"
                    ><i class="la la-map mr-2 text-color-2 font-size-18"></i
                    >Address:</span
                  >
                  123 Little Baker St, NY
                </li>
                <li>
                  <span class="text-color"
                    ><i class="la la-phone mr-2 text-color-2 font-size-18"></i
                    >Phone:</span
                ...
                <li>
                  <span class="text-color"
                    ><i
                      class="la la-envelope mr-2 text-color-2 font-size-18"
                    ></i
                    >Email:</span
              ...
              <ul class="list-items pb-4">
                <li class="d-flex align-items-center justify-content-between">
                  ...
                  <span class="text-success">9am - 7pm</span>
                </li>
                <li class="d-flex align-items-center justify-content-between">
                  <span>Saturday To Sunday</span>
                  <span class="text-color-2">Closed</span>
                </li>
              </ul>
