...
================================= -->
  <section class="card-area section-padding">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
          <div class="section-heading text-center">
            ...
            <h2 class="sec__title">{{ $t('headlines.topSearched') }}</h2>
            <p class="sec__desc">
      ...
      <!-- end row -->
      <div class="col-md-12 col-xs-10 more-link-wrap text-right">
        <a href="#" class="btn-text font-weight-medium"
          >{{ $t('links.viewAllBussinesses') }}
